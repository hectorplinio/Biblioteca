import { SvelteComponent, init, safe_not_equal, append_styles, element, space, create_component, attr, insert, append, mount_component, listen, is_function, transition_in, empty, group_outros, transition_out, check_outros, detach, destroy_component, add_render_callback, create_bidirectional_transition, run_all, create_slot, update_slot_base, get_all_dirty_from_scope, get_slot_changes, globals, noop, binding_callbacks } from 'svelte/internal';
